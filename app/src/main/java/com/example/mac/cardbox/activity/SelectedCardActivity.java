...
public class SelectedCardActivity extends AppCompatActivity {
    ...
    private Card card;
    private EditText et_front,et_back;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case DeleteCardSuccess_TAG:
                    Toast.makeText(SelectedCardActivity.this, "删除成功", Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                case UpdateCardSuccess_TAG:
                    Toast.makeText(SelectedCardActivity.this, "修改成功", Toast.LENGTH_SHORT).show();
                    finish();
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //自定义标题栏
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_selectedCard);
    ...
    private void initView() {
        et_front = findViewById(R.id.selectedCard_front);
        et_back = findViewById(R.id.selectedCard_back);

        et_front.setText(card.getCard_front());
        et_back.setText(card.getCard_back());
        et_front.setSelection(card.getCard_front().length());
        et_back.setSelection(card.getCard_back().length());
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_selectedcard_edit:
                AlertDialog dialog = new AlertDialog.Builder(SelectedCardActivity.this).setTitle("提示信息")
                        .setMessage("确认修改？")
                        .setCancelable(true)
                        ...
                        .setPositiveButton("是的", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                UpdateCurrentCard(card.getCard_id(),et_front.getText().toString(),et_back.getText().toString());
                            }
                        }).create();
                dialog.show();
            ...
            case R.id.menu_selectedcard_delete:
                AlertDialog dialog1 = new AlertDialog.Builder(SelectedCardActivity.this).setTitle("提示信息")
                        .setMessage("确认删除？")
                        .setCancelable(true)
                        .setNegativeButton("我想想", new DialogInterface.OnClickListener() {
                            @Override
